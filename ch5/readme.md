...
1. [determing-the-type-01.hs](./determine-the-type-01.hs) <br />
    a. Where
        ```haskell
            a = (*9) 6
                ```
                                                                                                                                                            ...
                                                                                                                                                            ```
                                                                                                                                                                ...
                                                                                                                                                                ```haskell
                                                                                                                                                                    f :: Bool
                                                                                                                                                                        ...
                                                                                                                                                                        2. [determing-the-tyoe-02.hs](./determine-the-type-02.hs). Given
                                                                                                                                                                            ```haskell
                                                                                                                                                                                x = 5
                                                                                                                                                                                    y = x + 5
                                                                                                                                                                                        w = y * 10
                                                                                                                                                                                            ```
                                                                                                                                                                                                ...
                                                                                                                                                                                                ```haskell
                                                                                                                                                                                                    w :: Num a => a
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        3. [determine-the-type-03.hs](./determine-the-type-03.hs). Given
                                                                                                                                                                                                            ```haskell
                                                                                                                                                                                                                x = 5
                                                                                                                                                                                                                    y = x + 5
                                                                                                                                                                                                                        z y = y * 10
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                `z`s `y` is scoped to `z`. The `y` declared outside is ignored, and
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    ```haskell
                                                                                                                                                                                                                                        z :: Num a => a -> a
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            4. [determine-the-type-04.hs](./determine-the-type-04.hs). Given
                                                                                                                                                                                                                                                ```haskell
                                                                                                                                                                                                                                                    x = 5
                                                                                                                                                                                                                                                        y = x + 5
                                                                                                                                                                                                                                                            f = 4 / y
                                                                                                                                                                                                                                                                ```
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    ```haskell
                                                                                                                                                                                                                                                                        f :: Fractional a => a
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            5. [determine-the-type-05.hs](./determine-the-type-05.hs). Given
                                                                                                                                                                                                                                                                                ```haskell
                                                                                                                                                                                                                                                                                    x = "Julie"
                                                                                                                                                                                                                                                                                        y = " <3 "
                                                                                                                                                                                                                                                                                            z = "Haskell"
